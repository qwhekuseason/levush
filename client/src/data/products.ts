...
export const products: Product[] = [
  ...
  // ─── GGG (God is Good, Great & Glorious) ─────────────────────────────────
  {
    id: 'ggg-collection',
    slug: 'ggg-collection',
  ...
  // ─── MADE FOR MORE (jpg) ─ already covered above ─────────────────────────
  // ─── LEVUSH TEXT LOGOS ───────────────────────────────────────────────────
  {
...
export const lookbook: LookbookItem[] = [
  ...
  { productId: 'ggg-collection', collection: 'Remix', caption: 'God is Good, Great & Glorious', ref: 'Psalm 107:1' },
];
